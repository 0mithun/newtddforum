...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    formateMessageTime: function formateMessageTime(timestamp) {
      ...
      return moment_timezone__WEBPACK_IMPORTED_MODULE_0___default()(timestamp).startOf('hour').fromNow(); //    return moment(timestamp).calendar();
    }
  }
});
      ...
      ? _c(
          ...
          [
            _vm._l(_vm.messageNotifications, function(notification, index) {
              return _c(
                "li",
                { key: index, staticClass: "list-group-item less-padding" },
                [
                  _c(
                    "a",
                    {
                    ...
                    [
                      ...
                      _c("div", { staticClass: " message" }, [
                        _c("div", { staticClass: "profilename" }, [
                          _c("b", {
