...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    showPaginatedItems: function showPaginatedItems() {
  ...
  methods: {
    ...
    searchThread: function searchThread() {
      // /threads/search
      var url = "/anecdotes/search?query=" + this.q;
    ...
    sortBy: function sortBy(sort) {
      ...
      var threads = _.orderBy(this.allThreads, [this.sort_by], "desc"); // this.paginatedItems = threads;
    ...
    ago: function ago(created_at) {
      return moment__WEBPACK_IMPORTED_MODULE_0___default()(created_at, "YYYY-MM-DD HH:mm:ss").fromNow() + "...";
    },
    searchThreads: function searchThreads() {
      ...
      this.search = true;
      axios.get("/anecdotes/search?query=" + this.q + "&sort_by=" + this.sort_by).then(function (res) {
    ...
    _c(
      ...
      [
                ...
                _c("div", { staticClass: "count-column" }, [
                  _vm._v(
                    "\n              " +
                      ...
                      "   " +
                      _vm._s(_vm._f("strPlural")(_vm.postsCount, "Result")) +
                      " \n            "
                  )
                ]),
                _vm._v(" "),
                _c("div", { staticClass: "sort-column" }, [
                  _c("div", { staticClass: "btn-group" }, [
                    _c(
                      ...
                      [
                        _vm.sort_by == "topRated"
                          ? [
                              _c("strong", { staticClass: "dark" }, [
                                _vm._v("Top Rated")
                              ])
                            ]
                          : _vm._e(),
                        _vm._v(" "),
                        _vm.sort_by == "created_at"
                          ? [
                              _c("strong", { staticClass: "dark" }, [
                                _vm._v("Most Recent")
                              ])
                        ...
                        _c(
                          "a",
                          {
                            ...
                            on: {
                              click: function($event) {
                                $event.preventDefault()
                                return _vm.sortBy("favorite_count")
                              }
                            }
                          },
                          [_vm._v("Most Favorited")]
        ...
        _vm.search
          ...
          : _vm._e(),
        _vm._v(" "),
        _vm._l(_vm.showPaginatedItems, function(thread, index) {
