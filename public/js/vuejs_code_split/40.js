...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      ...
      form: {
        ...
        wiki_image_copyright_free: true,
  ...
  methods: {
    selecetdTag: function selecetdTag() {
      var tags = this.form.tags.map(function (val) {
        return val.toLowerCase();
      });
      console.log(tags);
      console.log(this.form.tags);
      this.form.tags = tags; // this.form.tags = tags;
    },
    ...
    updateThread: function updateThread() {
      ...
      this.errors = [];
      this.appendData();
      var url = '/threads/' + this.thread.slug;
      axios.post(url, this.formData).then(function (res) {
        _this3.redirect_path = res.data.thread.path;
              ...
              _c(
                ...
                [
                  ...
                  _c("v-select", {
                    ...
                    on: { search: _vm.searchTag, input: _vm.selecetdTag },
                    scopedSlots: _vm._u([
                      {
                        key: "no-options",
                        fn: function(ref) {
                    ...
                    _vm.form.wiki_info_page_url != ""
                      ? _c("div", { staticClass: "form-group" }, [
                          ...
                          !_vm.form.wiki_image_copyright_free
                            ? _c("span", { staticClass: "help-block error" }, [
                                _vm._v(
                                  "Please confirm your right to post this image."
                                )
                              ])
                            : _vm._e()
                        ])
