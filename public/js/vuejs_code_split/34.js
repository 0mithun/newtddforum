...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    formatedTags: function formatedTags() {
      ...
      try {
        for (var _iterator = this.thread.tags[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var tag = _step.value;
          tags.push(tag.name);
        }
      } catch (err) {
