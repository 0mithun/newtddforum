...
class ThreadsController extends Controller
{
    ...
    public function store(CreateThreadRequest $request)
    {
        ...
        if (request('wiki_info_page_url') != '') {
            ...
            DownloadThreadImageJob::dispatch(request('wiki_info_page_url'), $thread, $authUser);
    ...
    public function update(UpdateThreadRequest $request, Thread $thread)
    {
        ...
        if (request('wiki_info_page_url') != '') {
            // WikiImageProcess::dispatch(request('wiki_info_page_url'), $thread, false);
            dispatch(new DownloadThreadImageJob(request('wiki_info_page_url'), $thread, $authUser));
        }
