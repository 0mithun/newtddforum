          ...
          <div class="modal-content">
              ...
              <div class="modal-body">
                  <div class="form-group">
                    <textarea name="reason" id="reason"  rows="2" class="form-control" v-model="reason"></textarea>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <button class="btn btn-primary" @click.prevent="report" :disabled="isDiabled">Report</button>
                  </div>
              </div>
          </div>
      </div>
