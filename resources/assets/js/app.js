...
Vue.component("favorite-thread", () =>
  import("./components/FavoriteThread.vue")
);
...
Vue.component("place-search", () =>
  import("./components/gmap/PlaceSearch.vue")
);
...
Vue.component("map-location", () =>
  import("./components/gmap/MapLocation.vue")
);

import * as VueGoogleMaps from "vue2-google-maps";

Vue.component("GmapCluster", () =>
  import("vue2-google-maps/dist/components/cluster")
);

Vue.component("user-online", () => import("./components/chat/UserOnline.vue"));
Vue.component("UserNotifications", () =>
...
Vue.component("message-notification", () =>
  import("./components/chat/MessageNotification.vue")
);
...
Vue.component("comment-counts", () =>
  import("./components/Counts/CommentCounts.vue")
);

Vue.component("favorite-counts", () =>
  import("./components/Counts/FavoriteCounts.vue")
);

Vue.component("like-counts", () =>
  import("./components/Counts/LikeCounts.vue")
);

Vue.component("view-counts", () =>
  import("./components/Counts/ViewCounts.vue")
);
Vue.component("post-counts", () =>
  import("./components/Counts/PostCounts.vue")
);
...
Vue.component("add-new-thread", () =>
  import("./components/threads/NewThread.vue")
);
Vue.component("edit-thread", () =>
  import("./components/threads/EditThread.vue")
);
Vue.component("delete-thread-btn", () =>
  import("./components/threads/DeleteThreadBtn.vue")
);
